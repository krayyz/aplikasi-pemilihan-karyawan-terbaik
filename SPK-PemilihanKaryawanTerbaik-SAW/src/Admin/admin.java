...
public class admin extends javax.swing.JFrame {
    ...
    public void menuKriteria() {
        ...
        txtKehadiran_KRI.setEditable(true);
        bCariKaryawan_KRI.setVisible(true);
        ic_hitung_w.setVisible(false);
        ic_hitung_b.setVisible(true);
        colorNoAktif(lHitung);
        bg_hitung.setVisible(false);
    ...
    protected void tabelAdmin() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "data gagal dipanggil" + exc);
        }
    }
    ...
    protected void IdPresensi() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Auto Number Gagal" + exc);
        }
    }
    ...
    private void initComponents() {
        ...
        cbPerilaku_KRI = new javax.swing.JComboBox<>();
        lKinerja_KRI = new javax.swing.JLabel();
        otKinerja_KRI = new javax.swing.JLabel();
        cbKinerja_KRI = new javax.swing.JComboBox<>();
        ...
        cbKehadiran_PRE = new javax.swing.JComboBox<>();
        ...
        cbJabatan_KAR = new javax.swing.JComboBox<>();
        lJenkel_KAR = new javax.swing.JLabel();
        otJenkel_KAR = new javax.swing.JLabel();
        cbJK_KAR = new javax.swing.JComboBox<>();
        ...
        lPeringkat_HIT.setText("Hasil Akhir Penilaian Karyawan");
        ...
        txtNIK_KAR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNIK_KARActionPerformed(evt);
            }
        });
        ...
        cbJabatan_KAR.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Manager Finance", "Admin", "Manager Operasional", "Team Leader", "Help Desk", "Teknisi", "Waiters", "Driver" }));
    ...
    private void bCetak_karyawanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCetak_karyawanActionPerformed
        try {
            ...
            par.put("Logo", image);
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("/Laporan/DK.jasper"), par, conn);
    ...
    private void tbKaryawanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKaryawanMouseClicked
        ...
        String ab = tbKaryawan.getValueAt(brs,0).toString();
        String ac = tbKaryawan.getValueAt(brs,1).toString();
        String ad = tbKaryawan.getValueAt(brs,2).toString();
        String ae = tbKaryawan.getValueAt(brs,3).toString();
        String af = tbKaryawan.getValueAt(brs,4).toString();
        String ag = tbKaryawan.getValueAt(brs,5).toString();
        String ambil2 = tbKaryawan.getValueAt(brs, 6).toString();
        String ai = tbKaryawan.getValueAt(brs,7).toString();
        String aj = tbKaryawan.getValueAt(brs,8).toString();
        Date tgl=null;
        try {
            tgl = Dateformat.parse(tbKaryawan.getValueAt(brs, 6).toString());
        ...
        txtNIK_KAR.setText(ab);
        txtNama_KAR.setText(ac);
        txtEmail_KAR.setText(ad);
        txtTelp_KAR.setText(ae);
        txtAlamat_KAR.setText(af);
        txtTempatLahir_KAR.setText(ag);
       cbTglLahir_KAR.setDate(tgl);
        cbJK_KAR.setSelectedItem(ai);
        cbJabatan_KAR.setSelectedItem(aj);
...
//        bCetakLaporan_HIT.setEnabled(true);
    ...
    private void bCetak_PREActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCetak_PREActionPerformed
        try {
            ...
            par.put(JRParameter.REPORT_LOCALE, locale);
            par.put("Logo", image);
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("/Laporan/DP.jasper"), par, conn);
            JasperViewer.viewReport(jp, false);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, e);
        }
    ...
    private void bCetak_BOBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCetak_BOBActionPerformed
        try {
            ...
            par.put(JRParameter.REPORT_LOCALE, locale);
            par.put("Logo", image);
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("/Laporan/DB.jasper"), par, conn);
            JasperViewer.viewReport(jp, false);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, e);
        }
    ...
    private void bCetak_KRIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCetak_KRIActionPerformed
        try {
            ...
            par.put(JRParameter.REPORT_LOCALE, locale);
            par.put("Logo", image);
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("/Laporan/DKT.jasper"), par, conn);
            JasperViewer.viewReport(jp, false);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, e);
        }
    ...
    private void bCetakLaporan_HITActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCetakLaporan_HITActionPerformed
        try {
            ...
            par.put(JRParameter.REPORT_LOCALE, locale);
            par.put("Logo", image);
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("/Laporan/DH.jasper"), par, conn);
            JasperViewer.viewReport(jp, false);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, e);
        }
    ...
    private void txtNIK_KARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNIK_KARActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNIK_KARActionPerformed
