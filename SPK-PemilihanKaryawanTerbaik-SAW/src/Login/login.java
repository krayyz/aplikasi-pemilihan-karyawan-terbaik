...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pKanan.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 680, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\ihrom\\OneDrive\\Documents\\project\\img3.jpg")); // NOI18N
        pKanan.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(102, 128, 570, 480));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        String SQL = "Select * from admin where Username='"+txtUsernameLogin.getText()+"' or pass='"+String.valueOf(txtPassword_login.getText())+"'";
        try{
            PreparedStatement state = conn.prepareStatement(SQL);
            ResultSet Result = state.executeQuery(SQL);
            if(Result.next()){
                if(txtUsernameLogin.getText().equals(Result.getString("Username"))&&String.valueOf(txtPassword_login.getText()).equals(Result.getString("pass"))){
                    Session.setUsername(Result.getString("Username"));
                    JOptionPane.showMessageDialog(null, "\tLogin Sukses \nSelamat Datang "+Result.getString("nama"));
                    new admin().setVisible(true);
                    this.dispose();
                }else if(!txtUsernameLogin.getText().equals(Result.getString("Username")) || String.valueOf(txtPassword_login.getText()).equals(Result.getString("pass"))){
                    JOptionPane.showMessageDialog(null, "Username Salah!", "Error!", JOptionPane.ERROR_MESSAGE);
                }else if(!txtUsernameLogin.getText().equals(Result.getString("pass")) || txtUsernameLogin.getText().equals(Result.getString("Username"))){
